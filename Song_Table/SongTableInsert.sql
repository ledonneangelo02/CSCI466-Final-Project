...
INSERT into Song (Name,MainArtist,Genre,SongLen,CoverArt) VALUES("I Don't Care (with Justin Bieber)","Ed Sheeran","pop",220,"https://upload.wikimedia.org/wikipedia/en/8/86/Lil_Tecca_-_Ransom.png");
INSERT into Song (Name,MainArtist,Genre,SongLen,CoverArt) VALUES("Ransom","Lil Tecca","trap music",131,"https://upload.wikimedia.org/wikipedia/en/6/6d/Sam_Smith_-_How_Do_You_Sleep%3F.png");
INSERT into Song (Name,MainArtist,Genre,SongLen,CoverArt) VALUES("How Do You Sleep?","Sam Smith","pop",202,"https://upload.wikimedia.org/wikipedia/en/6/69/Ed_Sheeran_%26_Justin_Bieber_-_I_Don%27t_Care.png");
...
INSERT into Song (Name,MainArtist,Genre,SongLen,CoverArt) VALUES("Money In The Grave (Drake ft. Rick Ross)","Drake","canadian hip hop",205,"https://production-digtracks-com.s3-ap-northeast-1.amazonaws.com/uploads/cover_art/file/54572/coverart.jpg");
